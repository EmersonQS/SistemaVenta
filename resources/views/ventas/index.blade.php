...
<script>
  class VentaManager extends CrudManager {
    ...
    calculateTotals() {
      ...
      [...tbody.querySelectorAll('tr')].forEach(row => {
        ...
        } else if (afectacionCodigo === '20') {
          op_exonerada += itemSubtotal;
        } else if (afectacionCodigo === '30') {
          op_inafecta += itemSubtotal;
        }
  ...
  document.getElementById('menuVentas').classList.add('menu-open');

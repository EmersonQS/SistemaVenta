        ...
        <div class="col-md-12">
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <button class="nav-link" id="nav-registrar-tab" data-bs-toggle="tab"
                        data-bs-target="#nav-registrar" type="button" role="tab" aria-controls="nav-registrar"
                        aria-selected="false">Registrar Cliente</button>
                </div>
            </nav>
                ...
                <div class="tab-pane fade show active" id="nav-buscar" role="tabpanel" aria-labelledby="nav-buscar-tab">
                    <div class="row mt-2">
                        <div class="col-md-12">
                            ...
                            <input type="text" id="cliente_razon_social" class="form-control form-control-sm"
